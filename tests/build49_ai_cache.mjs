...
assert.match(html,/app-enhancements\.js\?v=55/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=55',method:'GET',mode:'cors'};
