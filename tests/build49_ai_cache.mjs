...
assert.match(html,/app-enhancements\.js\?v=54a/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=54a',method:'GET',mode:'cors'};
