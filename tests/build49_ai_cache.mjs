...
assert.match(html,/app-enhancements\.js\?v=49b/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=49b',method:'GET',mode:'cors'};
...
console.log('build49b AI button, versioned script and PWA network-first refresh passed');
