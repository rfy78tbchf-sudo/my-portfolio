...
assert.match(html,/app-enhancements\.js\?v=57f/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=57f',method:'GET',mode:'cors'};
