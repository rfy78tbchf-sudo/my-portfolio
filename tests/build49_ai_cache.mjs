...
assert.match(html,/app-enhancements\.js\?v=49d/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=49d',method:'GET',mode:'cors'};
