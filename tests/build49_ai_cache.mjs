...
assert.match(html,/app-enhancements\.js\?v=50/,'page requests a new URL for the AI UI');
...
const request={url:'https://example.test/app-enhancements.js?v=50',method:'GET',mode:'cors'};
