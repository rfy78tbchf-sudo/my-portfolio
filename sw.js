const CACHE='my-portfolio-shell-20260926-50c';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.png','./passkey.js','./app-enhancements.js?v=50c','./vendor/jszip.min.js'];
