const CACHE='my-portfolio-shell-20260926-54a';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.png','./passkey.js','./app-enhancements.js?v=54a','./realized-sales-ui.js?v=54a','./vendor/jszip.min.js'];
