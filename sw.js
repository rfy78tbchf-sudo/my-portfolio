const CACHE='my-portfolio-shell-20260926-55b';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.png','./passkey.js','./app-enhancements.js?v=55','./realized-sales-ui.js?v=55b','./vendor/jszip.min.js'];
