const CACHE='my-portfolio-shell-20260926-57f';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.png','./passkey.js','./app-enhancements.js?v=57f','./realized-sales-ui.js?v=56','./vendor/jszip.min.js'];
